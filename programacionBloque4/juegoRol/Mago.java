...
public class Mago extends Personaje {
	 ...
	 */
	public final int _FUERZA_MAX_MAGO = 15; 
	/**
	 * INTELIGENCIA MINIMA DEL MAGO
	 */
	public final int INTELIGENCIA_MIN_MAGO = 17;
	/**
	...
	// Constructor
	public Mago(String nombre, TipoRaza raza, int fuerza, int inteligencia, int vidaMaxima)
	...
	public void setInteligencia(int inteligencia) throws PersonajeException {
		...
		if (inteligencia < INTELIGENCIA_MIN_MAGO) {
			throw new PersonajeException(
					"La inteligencia no puede ser menor que " + INTELIGENCIA_MIN_MAGO + " para el mago");
		}
	...
	public void setFuerza(int fuerza) throws PersonajeException {
		if (fuerza > _FUERZA_MAX_MAGO) {
			throw new PersonajeException(
					"La fuerza no puede ser mayor que " + _FUERZA_MAX_MAGO+ " para el mago");
		}

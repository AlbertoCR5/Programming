...
public class Alumno extends Persona {
	...
	public void enviarCorreo(String mensaje, Persona destinatario) throws IESException {
		
		if (getEdad() < 18 && (!(destinatario instanceof Profesor))) {
			throw new IESException("Solo puedes enviar mensajes a profesores");
		}
		
		super.enviarCorreo(mensaje, destinatario);
	}
